...
console.log(`Hello,${userName}! Welcome to our Bingo game!`);
console.log('You will start off with 1000 points. Every turn you take will cost you 10 points off. Try to win with least number of turns.')
...
function drawingNumbers(){
    ...
    do { 
        ...
        checkLines();
        console.log('This is your card now:');
        console.table(bingoCard);
...
function countRoundsAndPoints() {
    ...
    console.log(`This is a round number ${rounds}`);
...
function checkLines() {
    ...
    if(lineCompleted === false){
        if(lineOne === 5 || lineTwo === 5 || lineThree === 5){
            ...
            console.log("Congrats! You have got a LINE!")
            lineCompleted = true;
        }
    }
}
